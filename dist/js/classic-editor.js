...
/* harmony import */ var _utils_find_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/find-elements */ "./src/js/utils/find-elements.js");
/* harmony import */ var _utils_replace__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/replace */ "./src/js/utils/replace.js");
...
$(document).on('click', '.js-icw-check', function (e) {
  ...
  wp.apiRequest({
    ...
    if (data === true) {
      ...
      Object(_utils_replace__WEBPACK_IMPORTED_MODULE_2__["default"])(url);
    } else {
      // show the error
...
$(document).on('click', '.js-icw-view', function (e) {
  e.preventDefault();
  var url = $(this).data('check');
  var elements = Object(_utils_find_elements__WEBPACK_IMPORTED_MODULE_1__["default"])(url);
